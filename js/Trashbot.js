// Definición del modelo de reconocimiento de imágenes
        ...
        const imageURL = "https://teachablemachine.withgoogle.com/models/dnVW7JTZK/";
...
async function sendCommand(printValue) {
    ...
    const url = `http://192.168.1.19/${printValue === 'A' ? 'A' : printValue === 'B' ? 'B' : printValue === 'C' ? 'C' : printValue === 'D' ? 'D' : printValue === 'E' ? 'E' : 'F'}`;
